...
EMAIL_SIGNATURE_REGEXES = {
    ...
    DARREN_INDYKE: re.compile(r"DARREN K. INDYKE.{,100}?\**\nThe\s+information\s+contained\s+in\s+this\s+communication.{,150}?Darren K.[\n\s]+?[Il]ndyke(,\s+PLLC)?\s+—\s+All\s+rights\s+reserved\.? ?\n\*{50,120}(\n\**)?", re.DOTALL),
