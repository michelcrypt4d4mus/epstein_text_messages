...
EMAIL_SIGNATURE_REGEXES = {
    ...
    JEFFREY_EPSTEIN: re.compile(r"(([* 0,]+|please note)\n+)?([>»•]+ )*The info[r=]mation containe[d=] i[n=] th[i=]s communication.{,556}all\s+([>»] )*attachment[s=].( copyright [-=]all rights reserved?)?", re.DOTALL),
