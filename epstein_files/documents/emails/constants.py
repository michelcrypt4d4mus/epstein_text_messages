...
EMAIL_SIGNATURE_REGEXES = {
    ...
    JEFFREY_EPSTEIN: re.compile(r"(([* 0,]+|please note.{,6})\n+)?([>»•]+ )*The info.mation containe. i. th.s.communicati.{,558}all\s+([>»] )*attachm.nt[s=].( copyright [-=]all rights reserved?)?", re.DOTALL),
