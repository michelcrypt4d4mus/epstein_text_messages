...
EMAILER_ID_PATTERNS: dict[str, str] = {
    ...
    LESLEY_GROFF: r"Lesley\s*Gro(ff)?",
    ...
    LYN_FONTANILLA: r"L.nn? Fontanilla",
    ...
    SERGEY_BELYAKOV: r"Sergey\s*Belyako|Беляков\s*Сергей|Cepre(ct|il) [6BES][\w.]+|6(er|of)no\w+\s+[CE]\w+",
