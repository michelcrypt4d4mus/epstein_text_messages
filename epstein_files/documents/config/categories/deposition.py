...
DEPOSITION_CFGS = [
    ...
    DocCfg(id='EFTA00009229', author='Alex Acosta', note='pages 1-100', date='2020-04-30', is_interesting=True),
    DocCfg(id='EFTA00009329', author='Alex Acosta', note='pages 101-200', date='2020-04-30', is_interesting=True),
    DocCfg(id='EFTA00009016', author='Alex Acosta', note='pages 201-300', date='2020-04-30', is_interesting=True),
    DocCfg(id='EFTA00009116', author='Alex Acosta', note='pages 300-411', date='2020-04-30', is_interesting=True),
    DocCfg(
        id='EFTA00008744',
        author='FBI',
        date='2021-03-29',
