...
GOVERNMENT_CFGS = [
    ...
    fbi_interview('EFTA00153700', JUAN_ALESSI, date='2020-03-26'),
    fbi_interview('EFTA00157608', JUAN_ALESSI, recipient_uncertain=True, date='2020-03-26', duplicate_ids=['EFTA00091924'], dupe_type='redacted'),
    ...
    fbi_interview('EFTA00269572', 'David Richard Mullen'),
    ...
    fbi_interview('EFTA00269967', UNKNOWN_GIRL, date='2013-07-05', note=f"about {RONALD_EPPINGER}"),
    ...
    fbi_tip('EFTA00128843', 'Confidential Human Source', BORIS_NIKOLIC, date='2021-11-23'),
    ...
    fbi_internal('EFTA00031372'),
    fbi_internal('EFTA00031378'),
    fbi_internal('EFTA01649361'),
    fbi_internal('EFTA01654144'),
    fbi_internal('EFTA01656356'),
    ...
    usanys_internal_email('EFTA00019953'),
    usanys_internal_email('EFTA00020517'),
    usanys_internal_email('EFTA00014619'),
