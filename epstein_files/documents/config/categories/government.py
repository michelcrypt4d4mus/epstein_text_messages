...
GOVERNMENT_CFGS = [
    ...
    bop_doc('EFTA00039025', "report on death of Jeffrey Epstein", is_very_interesting=True),
    bop_doc('EFTA00039190', 'Special Housing Units', '2016-11-23', is_interesting=False),
    bop_doc('EFTA00034275', "report on Epstein's suicide attempt", '2019-07-23', is_very_interesting=True),
    bop_doc(
        'EFTA00019348',
