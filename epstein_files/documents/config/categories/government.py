...
GOVERNMENT_CFGS = [
    ...
    fbi_tip('EFTA01249586', 'abduction by Jay-Z, Harvey Weinstein, and Jeffrey Epstein'),
    fbi_tip('EFTA01249191', f"from {LES_WEXNER}'s former bodyguard", is_interesting=5, show_full_panel=True),
    ...
    fbi_tip('EFTA01249848', f"from Erez Zadok about Epstein's connection to the Wexner Foundation"),
    fbi_tip(
        'EFTA00108851',
