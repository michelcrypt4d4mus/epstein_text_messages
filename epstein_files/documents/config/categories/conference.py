...
CONFERENCE_CFGS = [
    ...
    DocCfg(id='023123', author=ASU_ORIGINS_PROJECT, note=f"{STRANGE_BEDFELLOWS} (old draft)"),
    DocCfg(id='023120', author=ASU_ORIGINS_PROJECT, note=STRANGE_BEDFELLOWS, duplicate_ids=['023121'], dupe_type='earlier'),
