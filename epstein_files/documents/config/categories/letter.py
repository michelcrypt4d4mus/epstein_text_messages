...
LETTER_CFGS = [
    ...
    immigration_letter('EFTA00314931', TERJE_ROD_LARSEN, '2017-06-08', 'International Peace Institute'),
    immigration_letter('EFTA00308104', MARTIN_NOWAK, description=f'possibly about {MASHA_DROKOVA}', show_with_name=MASHA_DROKOVA),
