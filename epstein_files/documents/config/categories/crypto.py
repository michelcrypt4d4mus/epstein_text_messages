...
CRYPTO_CFGS = [
    ...
    EmailCfg(id='EFTA00398745', highlight_quote='Nice seeing you. Please read #2 dot three', note=f"Epstein asks {HOWARD_LUTNICK} to read something after the island visit", is_interesting=20),
