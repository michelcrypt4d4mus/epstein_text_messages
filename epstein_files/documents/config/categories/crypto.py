...
CRYPTO_CFGS = [
    ...
    DocCfg(id='EFTA01088644', author=BLOCKCHAIN_CAPITAL, note="pitch deck", date='2015-10-01', is_interesting=6),
    DocCfg(id='EFTA00604942', author=BLOCKCHAIN_CAPITAL, note="Investor Update", date='2015-10-01', is_interesting=6),
    DocCfg(id='EFTA01089535', author=CRYPTO_CURRENCY_PARTNERS_II, note=f"investor report", date='2014-10-01', is_interesting=6),
    DocCfg(id='EFTA01089506', author=CRYPTO_CURRENCY_PARTNERS_II, note=f"investor report", date='2014-11-01', is_interesting=6),
    DocCfg(id='EFTA01089500', author=CRYPTO_CURRENCY_PARTNERS_II, note=f"investor report", date='2015-01-01', is_interesting=6),
    DocCfg(id='EFTA00621239', author=CRYPTO_CURRENCY_PARTNERS_II, note=f"investor report", date='2014-10-01', is_interesting=6),
    ...
    EmailCfg(id='EFTA00664424', note=f"{BROCK_PIERCE} suggests {LARRY_SUMMERS} could get involved with Tether and Noble Bank", is_interesting=12),
    ...
    DocCfg(
        ...
        note="photo of Epstein and Howard Lutnick on Epstein's island years after Lutnick claimed he stopped associating with Epstein",
    ...
    EmailCfg(
        id='EFTA00462693',
        duplicate_ids=['EFTA00462650'],
        dupe_type='quoted',
        highlight_quote='as a close friend of the Lutnicks',
        note=f"Epstein didn't use the $50,000 table for 10 he bought",
        show_with_name=HOWARD_LUTNICK,
        truncate_to=EMAIL_TRUNCATE_TO,
    ),
    ...
    EmailCfg(
        id='EFTA00398729',
        author_reason='visible in EFTA01913269',
        duplicate_ids=['EFTA00661498', 'EFTA01913269'],
        note=f'{HOWARD_LUTNICK} visit to the island',
        recipients=[BRICE_GORDON, JEFFREY_EPSTEIN],
        truncate_to=NO_TRUNCATE,
    ),
    EmailCfg(id='EFTA01912949', recipients=[BRICE_GORDON, LESLEY_GROFF], author_reason='visible in EFTA01913269', visible_in_id='EFTA00398729'),
    ...
    EmailCfg(id='EFTA02339913', author=LINDA_STONE, author_reason='signature'),
    EmailCfg(id='EFTA02363579', author=LINDA_STONE, author_reason='signature'),
    ...
    DocCfg(
        ...
        truncate_to=(1_240, 1_500) if args.output_most_interesting else (500, 3_000),
