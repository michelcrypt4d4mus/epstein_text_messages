...
EMAILS_CONFIG = [
    ...
    EmailCfg(id='EFTA02143419', author=LESLEY_GROFF, author_uncertain=True, truncate_to=1500),
    ...
    EmailCfg(id='EFTA00658903', author=SHAHER_ABDULHAK_BESHER, note='Epstein serving as intermediary during Yemen negotiations', is_interesting=10),
    ...
    EmailCfg(id='EFTA02415612', note='invitation to a party in Cairo from oligarch Vladislav Doronin', is_interesting=True),
