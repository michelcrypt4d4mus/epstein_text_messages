...
EMAILS_CONFIG = [
    ...
    EmailCfg(id='EFTA02415254', author=LANDON_THOMAS, author_reason='quoted reply'),
    ...
    EmailCfg(id='030506', recipients=[CELINA_DUBIN], recipient_uncertain='"Unc"'),
    EmailCfg(id='030507', recipients=[CELINA_DUBIN], recipient_uncertain='"Unc"'),
    EmailCfg(id='030508', recipients=[CELINA_DUBIN], recipient_uncertain='"Unc"'),
    EmailCfg(id='030509', recipients=[CELINA_DUBIN], recipient_uncertain='"Unc"'),
    ...
    EmailCfg(id='EFTA02611106', recipients=[JEFFREY_EPSTEIN]),
    ...
    EmailCfg(id='EFTA00961176', recipients=[NADIA_MARCINKO], recipient_uncertain='"flying lessons"'),
    ...
    EmailCfg(
        id='EFTA00701318',
        highlight_quote="i will coordinate with the people at the airport",
        is_interesting=5,
    ...
    EmailCfg(id='EFTA01738574', highlight_quote='peter thiel LOVED the secret socieity idea'),
    ...
    EmailCfg(id='028784', is_interesting=True, duplicate_ids=['026549'], note='two seminars: "Money" and "Power"'),
    EmailCfg(id='017827', is_interesting=True, note='Bannon / Peggy Siegal email about netflix doc on Epstein'),
    EmailCfg(
        id='030725',
        highlight_quote="finding out what the plan is in Moscow - send me her number",
        is_interesting=4,
        truncate_to=350,
    ),
    ...
    EmailCfg(id='029545', is_interesting=True, comment='Tyler Shears'),
    EmailCfg(id='025812', is_interesting=True, comment='Tyler Shears', note="Epstein's unhappy with his Google search results"),
    EmailCfg(
        id='026028',
    ...
    EmailCfg(id='023208_37', duplicate_ids=['023208_38', '023208_81']),
    EmailCfg(id='023208_51', author=None, recipients=[JEFFREY_EPSTEIN]),
    ...
    EmailCfg(id='EFTA00756819', author=CELINA_DUBIN),
    EmailCfg(id='EFTA00695169', author=CELINA_DUBIN),
    EmailCfg(id='EFTA00695166', author=CELINA_DUBIN),
    ...
    EmailCfg(id='EFTA02640711', author=HAMAD_BIN_JASSIM, note='Jabor Y / HBJ home address', is_interesting=5),
    ...
    EmailCfg(id='EFTA01923672', author=LESLEY_GROFF, author_uncertain=True),
    EmailCfg(id='EFTA00364250', author=LESLEY_GROFF, author_uncertain=True),
    ...
    EmailCfg(id='EFTA00488887', author=LESLEY_GROFF, author_uncertain=True),
    ...
    EmailCfg(id='EFTA02095399', author=LESLEY_GROFF, author_uncertain=True, truncate_to=350),
    EmailCfg(id='EFTA02143419', author=LESLEY_GROFF, author_uncertain=True, truncate_to=1_500),
    ...
    EmailCfg(id='EFTA02427509', author=LESLEY_GROFF, author_uncertain=True, recipients=[JEFFREY_EPSTEIN, DAVID_STERN], recipient_uncertain='meeting'),
    ...
    EmailCfg(id='EFTA02411543', author='Marcus Forss', author_reason='signature'),
    ...
    EmailCfg(id='EFTA02418453', author=PAOLO_ZAMPOLLI, recipients=[JEFFREY_EPSTEIN]),
    ...
    EmailCfg(id='EFTA02036029', show_with_name=REINALDO_AVILA_DA_SILVA),
    EmailCfg(
        id='EFTA01988194',
    ...
    EmailCfg(id='EFTA00429568', recipients=[BRAD_EDWARDS], recipient_uncertain='requests fwd', duplicate_ids=['EFTA00429569'], dupe_type='quoted'),
    EmailCfg(id='EFTA00429595', recipients=[JEFFREY_EPSTEIN], recipient_uncertain='requests fwd', duplicate_ids=['EFTA00429592', 'EFTA00429597'], dupe_type='quoted'),
    ...
    EmailCfg(id='EFTA01037518', recipients=[GANBAT_CHULUUNKHUU], highlight_quote='Not for email'),
    # Mostly notes to self
    EmailCfg(id='EFTA00716143', recipients=[JEFFREY_EPSTEIN]),
    EmailCfg(id='EFTA00645002', recipients=[JEFFREY_EPSTEIN]),
    ...
    EmailCfg(id='EFTA01742815', recipients=[JEFFREY_EPSTEIN]),
    ...
    EmailCfg(id='EFTA00533586', recipients=[KARYNA_SHULIAK]),
    ...
    EmailCfg(id='EFTA00393210', recipients=[LESLEY_GROFF], recipient_uncertain=True),
    EmailCfg(id='EFTA01900311', recipients=[LESLEY_GROFF], recipient_uncertain=True, duplicate_ids=['EFTA02721806']),
    ...
    EmailCfg(id='EFTA02088686', recipients=[LESLEY_GROFF], recipient_uncertain=True, highlight_quote='Jeffrey would like Jojo to deliver your ring to you', is_interesting=True),
    ...
    EmailCfg(id='EFTA00363687', recipients=[LESLEY_GROFF, 'Jennifer Hill']),
    ...
    EmailCfg(id='EFTA02541344', note=f"{BROCK_PIERCE} on marriage and polygamy with people named Crystal and Sue", is_interesting=7),
    EmailCfg(
        id='EFTA02641951',
        is_interesting=10,
        note=f"{DAVID_STERN} recommends ProtonMail for secure communications (so Epstein might have other email addresses)",
    ),
    ...
    daily_schedule_email('EFTA01748418'),
    daily_schedule_email('EFTA00368932'),
    ...
    daily_schedule_email('EFTA01775504'),
    daily_schedule_email('EFTA01921538'),
    daily_schedule_email('EFTA00380151'),
    daily_schedule_email('EFTA01941879'),
    daily_schedule_email('EFTA02041031'),
    ...
    daily_schedule_email('EFTA00363093', author=LESLEY_GROFF, author_uncertain=True),
    daily_schedule_email('EFTA00380302', author=LESLEY_GROFF, author_uncertain=True),
    daily_schedule_email('EFTA00675999', author=LESLEY_GROFF, author_uncertain=True),
    daily_schedule_email('EFTA00393023', author=LESLEY_GROFF, author_uncertain=True),
    daily_schedule_email('EFTA00361853', author=LESLEY_GROFF, author_uncertain=True),
    daily_schedule_email('EFTA00642517', author=LESLEY_GROFF, author_uncertain=True),
    daily_schedule_email('EFTA00322044', author=LESLEY_GROFF, author_uncertain=True),
    daily_schedule_email('EFTA00338290', author=LESLEY_GROFF, author_uncertain=True),
    daily_schedule_email('EFTA01748588', author=LESLEY_GROFF, author_uncertain=True, duplicate_ids=['EFTA00669595']),
    daily_schedule_email('EFTA00361816', author=LESLEY_GROFF, author_uncertain=True),
    ...
    daily_schedule_email('EFTA00364173', author=LESLEY_GROFF, author_uncertain=True),
    ...
    daily_schedule_email('EFTA00388164', recipients=[LESLEY_GROFF]),
    daily_schedule_email('EFTA00362202', recipients=[LESLEY_GROFF], recipient_uncertain=True),
    daily_schedule_email('EFTA00362192', recipients=[LESLEY_GROFF], recipient_uncertain=True),
    daily_schedule_email('EFTA00361939', recipients=[LESLEY_GROFF], recipient_uncertain=True),
    ...
    daily_schedule_email(
        ...
        recipients=[JOJO_FONTANILLA, LYN_FONTANILLA, RICHARD_BARNETT, SUE_HAMBLIN],
    ...
    meeting_notification('EFTA00528712', author=KARYNA_SHULIAK),
    ...
    EmailCfg(id='EFTA00677266', note=f"Epstein brokering a meeting between Senegalese politicians and Chinese businessmen"),
    ...
    EmailCfg(
        id='EFTA02513560',
        is_interesting=10,
        note=f"{JEAN_LUC_BRUNEL} doesn't want to speak on the phone",
        truncate_to=500,
    ),
    ...
    EmailCfg(id='EFTA00717315', note='raising money for a synagogue in NYC'),
    EmailCfg(id='EFTA01013413', note='Reza Bundy is the founder of IronPlanet'),
    EmailCfg(id='EFTA00625796', note="someone signing up for Christie's education possibly for visa purposes"),
    EmailCfg(id='EFTA02339109', note=f'someone named Sue ({SUE_HAMBLIN}?) needs help (probably a sham marriage to {BROCK_PIERCE}, see later emails)', is_interesting=5),
    ...
    EmailCfg(id='EFTA02412854', note=f'who\'s "D>>>" and what does he have to be careful about?', is_interesting=2),
    ...
    EmailCfg(id='EFTA00039802', duplicate_ids=['EFTA00039809'], is_interesting=False),
    ...
    EmailCfg(id='EFTA00703266', duplicate_ids=['EFTA01909242']),
    EmailCfg(id='EFTA00952901', duplicate_ids=['EFTA01909520']),
    EmailCfg(id='EFTA00993416', duplicate_ids=['EFTA01916290']),
    EmailCfg(id='EFTA00692437', duplicate_ids=['EFTA01909590']),
    EmailCfg(id='EFTA00717931', duplicate_ids=['EFTA01774218']),
    EmailCfg(id='EFTA01909829', duplicate_ids=['EFTA00668520']),
    ...
    EmailCfg(id='EFTA00876059', duplicate_ids=['EFTA02521167']),
    EmailCfg(id='EFTA00744113', duplicate_ids=['EFTA00766532'], dupe_type='redacted'),
    ...
    EmailCfg(id='EFTA02418669', visible_in_id='EFTA00778536'),  # unknown atty
    ...
    EmailCfg(id='EFTA00950685', truncate_to=400, duplicate_ids=['EFTA01910104']),
    EmailCfg(id='EFTA01761830', truncate_to=700, duplicate_ids=['EFTA00951704']),
    ...
    EmailCfg(id='EFTA02171907', truncate_to=NO_TRUNCATE, non_participants=[AUSTIN_HILL]),
    ...
    # unsorted
    EmailCfg(id='033096', note=f"Epstein met with the Russian government to give them tips about how to manipulate Trump", is_interesting=20),
    EmailCfg(id='EFTA02516264', is_interesting=True),
