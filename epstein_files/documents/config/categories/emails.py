...
EMAILS_CONFIG = [
    ...
    EmailCfg(id='031152', note='discussion of notoriously corrupt Kazakh politician (and friend of Epstein) Rakhat Aliyev', is_interesting=10),
    ...
    EmailCfg(id='EFTA02605815', is_interesting=10, highlight_quote="Am totally tricked out by Uncle Jeffrey today! Jeffrey boots, handbag, and w=tch!"),
    ...
    EmailCfg(id='EFTA02541344', note=f"{BROCK_PIERCE} on marriage and polygamy with people named Crystal and Sue", is_interesting=10),
    EmailCfg(id='EFTA02641951', note=f"{DAVID_STERN} recommends ProtonMail for secure communications (so Epstein might have other email addresses)", is_interesting=10),
    ...
    EmailCfg(id='EFTA01854384', note=f"{KARIM_WADE} asks if Epstein is free to meet the president (of Senegal?)", truncate_to=NO_TRUNCATE, is_interesting=10),
