...
EMAILS_CONFIG = [
    ...
    # Quotes
    EmailCfg(id='029679', is_interesting=True, highlight_quote='his driver MAtt was the bag man', description="(re: Trump)"),
    ...
    EmailCfg(id='032458', description='discussion of acquiring pieces for Epstein\'s art collection', truncate_to=NO_TRUNCATE),
    ...
    EmailCfg(
        ...
        description=f'Nicole Junkermann / {VALAR_VENTURES} meeting',
    ...
    EmailCfg(id='EFTA00920010', author=RENATA_BOLOTOVA, author_reason='renbolotova@gmail in body', description=f"{RENATA_BOLOTOVA} gets a job"),
    ...
    EmailCfg(id='EFTA02731512', recipients=[USANYS], description=f'specific allegations against {GHISLAINE_MAXWELL}'),
    ...
    EmailCfg(id='EFTA02541344', description=f"{BROCK_PIERCE} on marriage and polygamy with people named Crystal and Sue", is_interesting=True),
    ...
    EmailCfg(id='EFTA00758094', description='guest list includes Cyrus Vance, Jimmy Buffet, Harvey Weinstein, and more', is_interesting=True),
    ...
    EmailCfg(id='EFTA02415612', description='party invite from Doronin', is_interesting=True),
    EmailCfg(id='EFTA02087543', description="password for Epstein's RingCentral home security system", is_interesting=True, truncate_to=500),
    ...
    EmailCfg(id='EFTA02309843', description=f'{STEVE_BANNON} meets {EHUD_BARAK} over some "Jew food"', is_interesting=True),
