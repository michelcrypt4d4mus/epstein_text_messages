...
MONEY_CFGS = [
    ...
    deutsche_bank_doc('EFTA01361270', f"$60,000 payment from {SOUTHERN_TRUST_COMPANY} to {BEN_GOERTZEL}'s Novamente", date='2014-01-02'),
    ...
    jpm_doc(
        'EFTA01482878',
        f"statement with $150,000 payment (for surveillance of {GUZEL_GANIEVA}?) to ex-DOJ lawyer Dan Nardello who had prosecuted Epstein and Hoffenberg's Towers Financial ponzi scheme",
        is_interesting=10,
        truncate_to=1_000,
    ),
    ...
    # Misc
    DocCfg(id='EFTA00313730', note='receipt for massage training', is_in_chrono=False),
