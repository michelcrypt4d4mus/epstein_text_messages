...
MISC_CFGS = [
    ...
    daily_schedule('EFTA00284786', '2013-11-01'),
    daily_schedule('EFTA00285133', '2015-10-01'),
    daily_schedule('EFTA00287420', '2013-04-01'),
    daily_schedule('EFTA00314269', '2011-09-17'),
    daily_schedule('EFTA00285281', '2016-10-01'),
    ...
    DocCfg(id='EFTA00304853', note='jet reservation', date='2016-03-17'),
    ...
    DocCfg(id='EFTA01204217', note=f'amFAR Gala invitation showing Sam Jaradeh and {BORIS_NIKOLIC} on the host committee', date='2014-06-10'),
