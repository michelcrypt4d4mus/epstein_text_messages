...
class DocCfg:
    ...
    Attributes:
        ...
        author_reason (str, optional): Optional explanation of why this email was attributed to this author.
        ...
        author_uncertain_msg(str | bool, optional): Like setting `attribution_reason` and `is_attribution_uncertain=False`
    """
    id: str
