...
parser.add_argument('--whole-file', '-wf', action='store_true', help='print whole file (only used by epstein_search)')
...
parser.add_argument('positional_args', nargs='*', help='only used by epstein_search and epstein_show')
