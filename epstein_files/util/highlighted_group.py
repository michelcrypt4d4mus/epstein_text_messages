...
HIGHLIGHTED_GROUPS = [
    ...
    HighlightedGroup(
        label='china',
        style='bright_red',
        pattern=r"Beijing|CCP|Chin(a|e?se)(?! Daily)|Gino\s+Yu|Global Times|Guo|Hong|Huaw[ae]i|Kong|Jack\s+Ma|Kwok|Ministry\sof\sState\sSecurity|Mongolian?|MSS|Peking|PRC|SCMP|Tai(pei|wan)|Xi",
    ),
    HighlightedGroup(
        label='deepak_chopra',
