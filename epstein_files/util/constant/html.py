...
GOOGLE_FONTS_LINKS = """
    ...
    <link href="https://fonts.googleapis.com/css2?family=Gloria+Hallelujah&family=Kode+Mono:wght@400..700&family=PT+Mono&family=Space+Mono:ital,wght@0,400;0,700;1,400;1,700&family=Special+Elite&display=swap" rel="stylesheet">
"""
