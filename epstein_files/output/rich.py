...
def print_title_page_header() -> None:
    ...
    print_centered(f"These documents come from the Nov. 2025 House Oversight Committee release", style='gray74')
    print_centered(f"as we all as a curated selection of the January 2026 DOJ files.\n", style='gray74')
