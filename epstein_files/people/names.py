...
LUCREZIA_CAMPONOVO = 'Lucrezia Camponovo'
...
JON_TOMLINSON = 'Jon Tomlinson'
JOSHUA_FINK = 'Joshua Fink'
JUAN_ALESSI = 'Juan Alessi'
JULIA_MOLCHANOVA = 'Julia Molchanova'
JULIA_SANTOS = 'Julia Santos'
KARYNA_SHULIAK = 'Karyna Shuliak'
KEITH_FRANKEL = 'Keith Frankel'
KIA_KOKALITCHEVA = 'Kia Kokalitcheva'
...
MATTHIEU_DE_BOISSESON = 'Matthieu de Boisseson'
...
RICHARD_BARNETT = 'Richard Barnett'
RINALDO_RIZZO = 'Rinaldo Rizzo'
RONALD_EPPINGER = 'Ronald Eppinger'
SABRINA_STOROZUK = 'Sabrina Storozuk'
SAMUEL_C_KLAGSBRUN = 'Samuel C. Klagsbrun'
SANITA = 'Sanita'
SARAH_KELLEN = 'Sarah Kellen'
SCOTT_ROTHSTEIN = 'Scott Rothstein'
SETH_LLOYD = 'Seth Lloyd'
SHELLEY_ANNE_LEWIS = 'Shelley Anne Lewis'
...
SUE_HAMBLIN = 'Sue Hamblin'
TANCREDI_MARCHIOLO = 'Tancredi Marchiolo'
THAKSIN_SHINAWATRA = 'Thaksin Shinawatra'
TODD_BOEHLY = 'Todd Boehly'
...
YULIA_SILINSKAYA = 'Yulia Silinskaya'
...
HIGHBRIDGE_EQUITY_FUND = 'Highbridge Long/Short Equity Fund'
HIGHVIEW_GLOBAL_MACRO = 'Highview Global Macro'
JEEPERS_INC = 'Jeepers, Inc.'
JEGE_INC = 'JEGE, Inc.'
PINEHURST_PLUS = 'Pinehurst Plus'
