...
def oversight_file_location():
    return DocLocation(DOCS_DIR.joinpath('HOUSE_OVERSIGHT_019407.txt'))


@pytest.fixture
def extract_location():
    return DocLocation(DOCS_DIR.joinpath('HOUSE_OVERSIGHT_014797_1.txt'))


@pytest.fixture
def doj_file_location():
    return DocLocation(DOJ_TXTS_20260130_DIR.joinpath('DataSet 10', 'EFTA01751416.txt'))
