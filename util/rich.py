...
HIGHLIGHT_PATTERNS: dict[str, str] = {
    ...
    EUROPE_COLOR: fr"Le\s*Pen|Macron|(Angela )?Merk(el|le)|(Sebastian )?Kurz|(Vi(c|k)tor\s+)?Orbah?n|Terje(( (R[øo]e?d[- ])?)?Lars[eo]n)?|Ukrain(e|ian)|{EMAILER_REGEXES[THORBJORN_JAGLAND].pattern}",
