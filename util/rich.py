...
def print_other_site_link() -> None:
    ...
    title = wrap_in_markup_style(f"  ******* This is the Epstein {title.title()}s site *******  ", TITLE_STYLE)
    logger.debug(f"title markup: '{title}'")
    msg += f' site also generated by this code'
